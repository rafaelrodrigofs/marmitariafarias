...
try {
    ...
    if (!isset($_GET['numero']) || empty($_GET['numero'])) {
        throw new Exception('Número do pedido não fornecido');
    }
    ...
    $sql = "SELECT 
            ...
            WHERE p.num_pedido = :numero_pedido";
    ...
    // Colocar o pedido na lista correta conforme seu status
    $pedidos_por_status = [
        'emAnalise' => [],
        'emProducao' => [],
        'prontosEntrega' => []
    ...
    switch ($pedido['status_pedido']) {
        case 0:
            $pedidos_por_status['emAnalise'][] = $pedido_formatado;
            break;
        case 1:
            $pedidos_por_status['emProducao'][] = $pedido_formatado;
            break;
        case 2:
            $pedidos_por_status['prontosEntrega'][] = $pedido_formatado;
            break;
    }
